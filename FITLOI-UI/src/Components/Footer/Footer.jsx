    ...
    return (
        <footer className="footer-box">
            {/* <div className="footer-website-name">
                <h1 className="footer-name">FITLO</h1>
            </div> */}
            <div className="profile-card">
                ...
                <div className="social-icons">
                    ...
                    <a href="mailto:kiahnaisadore@gmail.com" className="icon">
                        <svg width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" fill="none">
                            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                            <path d="M22 6l-10 7L2 6"></path>
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/in/kiahna-isadore/" className="icon">
            ...
            <p className="copyright">© 2024 FITLIO. All rights reserved.</p>
        </footer>
    );
}
